...
async function populate() {
    ...
    const url = "https://zichenbao.github.io/23F-JavaScript-02-Week11-main/js/i-scream.json";
...
function showTopFlavors(jsonData) {
    ...
    for (let i = 0; i < topFlavors.length; i++) {
        ...
        if (topFlavors[i].name === "Lemonade" || topFlavors[i].name === "Caramel pudding") {
            article.classList.add("new-flavor");
        }
    }
}
